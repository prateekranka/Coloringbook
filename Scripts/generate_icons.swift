#!/usr/bin/env swift
// Icon generator script - run with: swift Scripts/generate_icons.swift
    ...
    var body: some View {
        ZStack {
            ...
            Text("G")
                ...
                .shadow(color: Color(red: 0.35, green: 0.55, blue: 0.65).opacity(0.3), radius: size * 0.02, x: size * 0.01, y: size * 0.01)
        }
...
func generateIcons(outputDirectory: URL) async throws {
    ...
    let contentsJSON = ContentsJSON(images: images, info: ContentsJSON.Info(author: "gouache-icon-generator", version: 1))
...
struct IconGeneratorCLI {
    static func main() async {
        let outputDir = FileManager.default.currentDirectoryDirectoryURL
            .appendingPathComponent("ColorFlow/Resources/Assets.xcassets/AppIcon.appiconset")
...
extension FileManager {
    var currentDirectoryDirectoryURL: URL {
