...
extension Template {
    ...
    static let catalogAspectRatios: [String: Double] = [
        ...
        "radiant-peaks": 1024.0 / 1536.0,
        "art-deco-bloom": 1024.0 / 1536.0,
        "compass-bloom": 1054.0 / 1492.0,
        "lion-crest": 1024.0 / 1536.0,
        "sunburst-bloom": 1024.0 / 1536.0,
        "lotus-crown": 1024.0 / 1536.0,
        "electric-starburst": 1024.0 / 1536.0
    ]
    ...
    static let bundledTemplates: [Template] = [
        ...
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000111")!,
                 name: "Radiant Peaks",
                 category: .abstract,
                 difficulty: .medium,
                 svgFilename: "radiant-peaks.svg",
                 thumbnailFilename: "thumb-radiant-peaks.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000112")!,
                 name: "Art Deco Bloom",
                 category: .abstract,
                 difficulty: .medium,
                 svgFilename: "art-deco-bloom.svg",
                 thumbnailFilename: "thumb-art-deco-bloom.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000113")!,
                 name: "Compass Bloom",
                 category: .abstract,
                 difficulty: .medium,
                 svgFilename: "compass-bloom.svg",
                 thumbnailFilename: "thumb-compass-bloom.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000114")!,
                 name: "Lion Crest",
                 category: .animals,
                 difficulty: .hard,
                 svgFilename: "lion-crest.svg",
                 thumbnailFilename: "thumb-lion-crest.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000115")!,
                 name: "Sunburst Bloom",
                 category: .abstract,
                 difficulty: .easy,
                 svgFilename: "sunburst-bloom.svg",
                 thumbnailFilename: "thumb-sunburst-bloom.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000116")!,
                 name: "Lotus Crown",
                 category: .mandalas,
                 difficulty: .hard,
                 svgFilename: "lotus-crown.svg",
                 thumbnailFilename: "thumb-lotus-crown.png"),
        Template(id: UUID(uuidString: "33333333-0000-0000-0000-000000000117")!,
                 name: "Electric Starburst",
                 category: .abstract,
                 difficulty: .medium,
                 svgFilename: "electric-starburst.svg",
                 thumbnailFilename: "thumb-electric-starburst.png"),
    ]
}
